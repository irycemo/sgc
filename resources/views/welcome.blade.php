...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative sm:flex bg-black sm:justify-center sm:items-center min-h-screen bg-blue-400 bg-teal-400 bg-orange-400 bg-indigo-400 bg-purple-400 bg-green-400 bg-yellow-400 bg-gray-400 selection:text-white">
            @if (Route::has('login'))
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="flex justify-center">
                    <svg viewBox="0 0 62 65" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-16 w-auto bg-red-400">
