...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative sm:flex bg-black sm:justify-center sm:items-center min-h-screen bg-blue-400 bg-orange-400 bg-indigo-400 bg-purple-400 bg-green-400 bg-yellow-400 bg-gray-400 selection:text-white">
            @if (Route::has('login'))
