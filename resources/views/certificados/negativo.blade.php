        ...
        <div>
            ...
            <div class="informacion" >
                ...
                <p class="fundamento">
                    ...
                    QUE HABIENDO EFECTUADO UNA REVISIÓN DE LOS PADRONES CATASTRALES EXISTENTES EN ESTA OFICINA A MI CARGO, NO SE ENCONTRÓ REGISTRO DE PROPIEDAD A NOMBRE DE: <strong> {{ $nombre }} {{ $ap_paterno }} {{ $ap_materno }} {{ $razon_social }}.</strong>
                </p>
