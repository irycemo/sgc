<div>
    ...
    @include('livewire.tramites-administrativos.modal-crear')

    @include('livewire.tramites-administrativos.modal-eliminar')

    @include('livewire.tramites-administrativos.modal-hacer-requerimiento')

    @include('livewire.tramites-administrativos.modal-ver-requerimiento')

    @include('livewire.tramites-administrativos.modal-asignar-valuador')

    @include('livewire.tramites-administrativos.modal-subir-archivo')

    @include('livewire.tramites-administrativos.modal-cambiar-estado')
