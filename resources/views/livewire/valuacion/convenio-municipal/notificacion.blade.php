<div>
    ...
    <div class="bg-white p-4 rounded-lg mb-5 shadow-lg">
        ...
        <div class="flex-auto text-center mb-3">
            ...
            <div class="inline-flex">
                ...
                <select class="bg-white rounded-l text-sm border border-r-transparent  focus:ring-0" wire:model="año">
                    @foreach ($años as $año_item)

                        <option value="{{ $año_item }}">{{ $año_item }}</option>
        ...
        <div class="mb-3">
            ...
            <button
                wire:click="buscarAvaluo"
                wire:loading.attr="disabled"
                wire:target="buscarAvaluo"
                type="button"
                ...
                <img wire:loading wire:target="buscarAvaluo" class="mx-auto h-4 mr-1" src="{{ asset('storage/img/loading3.svg') }}" alt="Loading">
