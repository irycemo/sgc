<div>
    ...
    <div class="p-4 flex-auto bg-white rounded-lg mb-3 shadow-md space-y-3">
        ...
        <div class="flex flex-wrap space-x-1 justify-center items-center">
            ...
            <input title="Oficina" placeholder="Oficina" type="number" class="bg-white rounded text-xs w-20 @error('oficina_origen') border-1 border-red-500 @enderror" wire:model.blur="oficina_origen">
    ...
    <div class="p-4 flex-auto bg-white rounded-lg mb-3 shadow-md space-y-3">
        ...
        <div class="flex flex-wrap space-x-1 justify-center items-center">
            ...
            <input title="Localidad" placeholder="Localidad" type="number" class="bg-white rounded text-xs w-20 @error('localidad_nuevo') border-1 border-red-500 @enderror" wire:model.blur="localidad_nuevo">

            <input title="Oficina" placeholder="Oficina" type="number" class="bg-white rounded text-xs w-20 @error('oficina_nuevo') border-1 border-red-500 @enderror" wire:model.blur="oficina_nuevo" readonly>

            <input title="Tipo de predio" placeholder="Tipo" type="number" class="bg-white rounded text-xs w-16 @error('tipo_nuevo') border-1 border-red-500 @enderror" wire:model="tipo_nuevo">
