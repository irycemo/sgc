                            ...
                            <div>
                                ...
                                <select class="bg-white rounded text-sm w-full" wire:model.lazy="modelo_editar.nombre_solicitante">
                                    ...
                                    @foreach ($notarias as $item)
                                        ...
                                        <option value="{{ $item->numero . ' - ' . $item->notario }}">{{ $item->numero }} - {{ $item->notario }}</option>
                        ...
                        @if($predio)
                            ...
                            <div class="text-sm my-3 flex items-center justify-between bg-gray-100 rounded-lg p-3">
                                ...
                                <button
                                    ...
                                    type="button"
                                    class="bg-green-400 hover:shadow-lg text-white font-bold px-4 py-2 rounded text-sm hover:bg-green-700 focus:outline-none flex items-center w-fit focus:outline-green-400 focus:outline-offset-2">
