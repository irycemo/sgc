<div>
    ...
    <div class="md:flex flex-col md:flex-row justify-between md:space-x-3 items-center bg-white rounded-xl mb-5 p-4 shadow-xl">
        ...
        <x-input-group for="tipo_tramite" label="Tipo de trámite" :error="$errors->first('tipo_tramite')" class="w-full">

            <x-input-select id="tipo_tramite" wire:model.live="tipo_tramite">
            ...
            <div class="overflow-x-auto rounded-lg shadow-xl border-t-2 border-t-gray-500">
                ...
                <x-table>
                    ...
                    <x-slot name="head">
                        ...
                        <x-table.heading>Tipo de trámite</x-table.heading>
                        ...
                        <x-table.heading>Línea de captura</x-table.heading>
                        <x-table.heading>Folio de pago</x-table.heading>
