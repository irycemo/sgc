<div>
    ...
    <div>
        ...
        @if(count($this->avisos))

            <div class="rounded-lg shadow-xl mb-5 p-4 font-thin md:flex items-center justify-between bg-white">

                <p class="text-xl font-extralight">Se encontraron: {{ number_format($this->avisos->total()) }} registros con los filtros seleccionados.</p>
            ...
            <div class="overflow-x-auto rounded-lg shadow-xl border-t-2 border-t-gray-500">
                ...
                <x-table>
                    ...
                    <x-slot name="head">
                        ...
                        <x-table.heading>Oficna</x-table.heading>
                        ...
                        @forelse ($this->avisos as $aviso)
                            ...
                            <x-table.row wire:loading.class.delaylongest="opacity-50" wire:key="row-{{ $aviso->id }}">
                                ...
                                <x-table.cell title="Folio aviso">
                                    ...
                                    {{ $aviso->año_aviso }}-{{ $aviso->folio_aviso }}-{{ $aviso->usuario_aviso }}

                                </x-table.cell>

                                <x-table.cell title="Entidad">

                                    {{ $aviso->entidad_nombre }}

                                </x-table.cell>

                                <x-table.cell title="Oficina">

                                    {{ $aviso->oficina->nombre }}

                                </x-table.cell>

                                <x-table.cell title="Asignado a">

                                    {{ $aviso->asignadoA->name }}
