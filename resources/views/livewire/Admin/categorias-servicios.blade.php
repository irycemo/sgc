<div class="">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-3xl tracking-widest py-3 px-6 text-gray-600 rounded-xl border-b-2 border-gray-500 font-thin mb-6  bg-white">Categorías</h1>
        ...
        <div class="flex justify-between">
            ...
            @can('Crear usuario')
                ...
                <button wire:click="abrirModalCrear" class="bg-gray-500 hover:shadow-lg hover:bg-gray-700 float-right items-center  text-sm py-2 px-4 text-white rounded-full focus:outline-none hidden md:block">
                    ...
                    @foreach($categorias as $categoria)
                        ...
                        <tr class="text-sm font-medium text-gray-500 bg-white flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b block lg:table-cell relative lg:static">
                                ...
                                @if($categoria->creadoPor != null)

                                    <span class="font-semibold">Registrado por: {{$categoria->creadoPor->name}}</span> <br>
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b block lg:table-cell relative lg:static">
                                ...
                                @if($categoria->actualizadoPor != null)

                                    <span class="font-semibold">Actualizado por: {{$categoria->actualizadoPor->name}}</span> <br>
