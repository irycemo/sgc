<div class="">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-3xl tracking-widest py-3 px-6 text-gray-600 rounded-xl border-b-2 border-gray-500 font-thin mb-6  bg-white">Valores unitarios por hectarea de predios rusticos</h1>
    ...
    @if($valores->count())
        ...
        <div class="relative overflow-x-auto rounded-lg shadow-xl border-t-2 border-t-gray-500 mt-5">
            ...
            <table class="rounded-lg w-full">
                ...
                <thead class="border-b border-gray-300 bg-gray-50">
                    ...
                    <tr class="text-xs font-medium text-gray-500 uppercase text-left traling-wider">
                        ...
                        <th wire:click="order('valor')" class="cursor-pointer px-3 py-3 hidden lg:table-cell">
