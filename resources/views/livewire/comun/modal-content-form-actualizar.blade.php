<div class="flex justify-center gap-3 mb-3 col-span-2 rounded-lg p-3">
    ...
    <x-input-group for="tipo_persona" label="Tipo de persona" :error="$errors->first('tipo_persona')" class="w-full">
        ...
        <x-input-select id="tipo_persona" wire:model.live="tipo_persona" class="w-full" disabled>
...
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 mb-3 col-span-2 rounded-lg p-3">
    ...
    @if(in_array($tipo_persona, ['FISICA', 'FÍSICA']))
        ...
        <x-input-group for="nombre" label="Nombre(s)" :error="$errors->first('nombre')" class="w-full">
            ...
            <x-input-text id="nombre" wire:model="nombre" readonly/>

        </x-input-group>

        <x-input-group for="ap_paterno" label="Apellido paterno" :error="$errors->first('ap_paterno')" class="w-full">

            <x-input-text id="ap_paterno" wire:model="ap_paterno" readonly/>

        </x-input-group>

        <x-input-group for="ap_materno" label="Apellido materno" :error="$errors->first('ap_materno')" class="w-full">

            <x-input-text id="ap_materno" wire:model="ap_materno" readonly/>

        </x-input-group>

        <div class=" col-span-3 rounded-lg">

            <x-input-group for="multiple_nombre" label="Nombre multiple (Opcional)" :error="$errors->first('multiple_nombre')" class="w-full sm:col-span-2 lg:col-span-3">
    ...
    @elseif($tipo_persona == 'MORAL')
        ...
        <x-input-group for="razon_social" label="Razon social" :error="$errors->first('razon_social')" class="w-full sm:col-span-2 md:col-span-3">

            <x-input-text id="razon_social" wire:model="razon_social" readonly/>
