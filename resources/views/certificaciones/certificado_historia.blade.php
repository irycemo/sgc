        ...
        <div>
            ...
            <div>
                ...
                <p class="parrafo">
                    ...
                    REGISTROS HISTORICOS DE LA SIGUIENTE PROPIEDAD, en la localidad de {{ $datos_control->oficina }}, municipio de {{ $datos_control->municipio }}:
                </p>
