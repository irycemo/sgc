    ...
    @can('Lista de predios')
        ...
        <x-nav-dropdown>
            ...
            <x-slot name="body">
                ...
                <a href="{{ route('predios_asignado') }}" class="capitalize font-medium text-sm  flex w-full  hover:bg-gray-100 p-2 px-4  rounded-xl hover:text-red-600">Cuentas asignadas</a>
