<div x-data="{openRoles:true, openDistritos:true}">
    ...
    @can('Lista de servicios')
        ...
        <div class="flex items-center mb-3 w-full justify-between hover:text-red-600 transition ease-in-out duration-500 hover:bg-gray-100 rounded-xl">
            ...
            <a href="{{ route('servicios') }}" class=" capitalize font-medium text-md  flex hover w-full  p-2 px-4 ">
    ...
    @can('Lista de trámites')
        ...
        <div class="flex items-center mb-3 w-full justify-between hover:text-red-600 transition ease-in-out duration-500 hover:bg-gray-100 rounded-xl">
            ...
            <a href="{{ route('tramites') }}" class=" capitalize font-medium text-md  flex hover w-full  p-2 px-4 ">
    ...
    @can('Lista de predios')
        ...
        <div class="flex items-center mb-3 w-full justify-between hover:text-red-600 transition ease-in-out duration-500 hover:bg-gray-100 rounded-xl">
            ...
            <a href="{{ route('predios') }}" class=" capitalize font-medium text-md  flex hover w-full  p-2 px-4 ">
