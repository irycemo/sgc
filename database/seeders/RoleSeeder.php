...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'Auditoria old', 'area' => 'Auditoria'])->syncRoles([$role1]);
        ...
        Permission::create(['name' => 'Área de gestión catastral', 'area' => 'Gestión catastral'])->syncRoles([$role1, $role2, $role4]);
        Permission::create(['name' => 'Captura al padron', 'area' => 'Gestión catastral'])->syncRoles([$role1, $role2, $role4]);
        Permission::create(['name' => 'Revisar traslados', 'area' => 'Gestión catastral'])->syncRoles([$role1, $role2, $role4]);
        Permission::create(['name' => 'Reasignar traslados', 'area' => 'Gestión catastral'])->syncRoles([$role1, $role2, $role4]);
        Permission::create(['name' => 'Valor catastral', 'area' => 'Gestión catastral'])->syncRoles([$role1, $role2, $role4]);
        Permission::create(['name' => 'Lista traslados', 'area' => 'Gestión catastral'])->syncRoles([$role1, $role2, $role4]);
        ...
        Permission::create(['name' => 'Tramites administrativos', 'area' => 'Anotaciones y T. A.'])->syncRoles([$role1, $role2, $role4]);
        ...
        Permission::create(['name' => 'Asignación de manzanas', 'area' => 'Cartografía'])->syncRoles([$role1, $role2]);
        ...
        Permission::create(['name' => 'Cambio de localidad', 'area' => 'Cartografía'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'Cartografia archivo', 'area' => 'Cartografía'])->syncRoles([$role1, $role2]);
        ...
        Permission::create(['name' => 'Preguntas', 'area' => 'Consulta'])->syncRoles([$role1, $role2, $role4]);
