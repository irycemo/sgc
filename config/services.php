...
return [
    ...
    */
    ...
    'sap' => [
        ...
        'SAP_TOKEN_USUARIO' => env('SAP_TOKEN_USUARIO'),
        'SAP_TOKEN_CONTRASEÑA' => env('SAP_TOKEN_CONTRASEÑA'),
        'SAP_GENERAR_TOKEN_URL' => env('SAP_GENERAR_TOKEN_URL'),
        ...
        'SAP_VALIDAR_LINEA_DE_CAPTURA_URL_ANTERIOR' => env('SAP_VALIDAR_LINEA_DE_CAPTURA_URL_ANTERIOR')
    ],
    ...
    'sistema_tramites_en_linea' => [
        ...
        'reactivar_aviso' => env('SISTEMA_TRAMITES_EN_LINEA_REACTIVAR_AVISO'),
