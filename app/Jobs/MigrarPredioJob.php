        ...
        try {
            ...
            DB::transaction(function () {
                ...
                $p = Predio::create([
                    ...
                    'distrito' => null,
                    'domicilio_notificacion' => trim($this->predio['noca_008']) . ' ' . trim($this->predio['exte_008']) . ' ' . trim($this->predio['adic_008']) . ' ' . trim($this->predio['inte_008']) . ' ' . trim($this->predio['nedi_008']) . ' ' . trim($this->predio['ndpt_008']) . ' ' . trim($this->predio['noco_008']) . ' ' . trim($this->predio['nopo_008']) . ' ' . trim($this->predio['nomu_008']) . ' ' . trim($this->predio['copd_008']),
