...
class Ventanilla extends Component
{
    ...
    public function updatedServicioSeleccionado(){
        ...
        $this->emit('cambioServicio', $this->servicio);
    ...
    public function mostrarComponente(string $categoria){
        ...
        if($componente == 'No encontrada'){
            ...
            $this->dispatchBrowserEvent('mostrarMensaje', ['error', 'Seleccione una catagoría correcta']);
    ...
    public function buscarTramite(){
        ...
        $this->validate(['tramite_folio' => 'required']);
        ...
        $this->emit('cargarTramite', $this->tramite);
