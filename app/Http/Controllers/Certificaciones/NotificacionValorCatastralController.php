...
class NotificacionValorCatastralController extends Controller
{
    ...
    public function general($avaluos, $tramite_inspeccion, $tramite_desglose){
        ...
        $pdf = Pdf::loadView('certificaciones.notificacion_valor_catastral_general', [
    ...
    public function fusion($avaluos, $tramite_inspeccion, $predios_fusionantes){
        ...
        $datos_control->predios_fusionantes = [];

        foreach ($predios_fusionantes as $predio) {

            array_push($datos_control->predios_fusionantes, $predio->cuentaPredial());
