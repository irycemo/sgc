...
use App\Exports\Reportes\CertificacionesExport;
...
class ReporteCertificaciones extends Component
{
    ...
    public function render()
    {
        ...
        $certificaciones = Certificacion::with('oficina:id,nombre', 'tramite:id,año,folio,usuario')
        ...
        return view('livewire.consultas.reportes.reporte-certificaciones', compact('certificaciones'));
