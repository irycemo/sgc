...
class ReporteAvaluos extends Component
{
    ...
    public function avisos(){
        ...
        return Avaluo::with('oficina:id,nombre', 'predio:id,localidad,oficina,tipo_predio,numero_registro', 'asignadoA:id,name')
    ...
    {
        return view('livewire.consultas.reportes.reporte-avaluos');
    }
}
