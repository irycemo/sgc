    ...
    public function buscarTramite(){
        ...
        try {
            ...
            foreach ($movimientos as $movimiento) {
                ...
                $this->historia = $this->historia . '<strong>Fecha:</strong> ' . $movimiento->fecha->format('d-m-Y') . ' ' . '<strong>Movmiento:</strong> ' . $movimiento->nombre . ' ' . '<br>' . $movimiento->descripcion . '<br><br>';
            }
